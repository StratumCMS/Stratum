...
@section('content')
    <div x-data="articleForm(@json($mediaItems))" x-init="init()" class="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl font-semibold text-foreground">Nouvel article</h1>
        ...
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 sm:space-y-6">
            @csrf
                        ...
                        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="content"
                                          ...
                                          placeholder="Contenu complet de votre article..."></textarea>
                                @error('content')
                                <p class="text-sm text-destructive flex items-center space-x-1">
                                    <i class="fas fa-exclamation-circle w-4 h-4"></i>
                                    <span>{{ $message }}</span>
                    ...
                    <div class="rounded-xl border bg-card text-card-foreground shadow-sm">
                        <div class="p-4 sm:p-6 space-y-3">
                            <button type="submit"
                                ...
                                <span x-text="isSubmitting ? 'Création...' : 'Créer l\'article'"></span>
                            </button>
                            <a href="{{ route('admin.articles') }}"
                               class="inline-flex items-center justify-center gap-2 rounded-lg border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 text-sm font-medium transition-colors w-full">
                                <i class="fas fa-times w-4 h-4"></i>
...
@push('scripts')
    <script>
        ...
        function articleForm(initialMediaItems) {
            return {
                form: {
                    title: '{{ old('title', '') }}',
