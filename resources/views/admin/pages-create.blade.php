            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                        <i class="fas fa-file-plus text-primary text-sm"></i>
                    </div>
                    <div>
                        <h1 class="text-xl sm:text-2xl font-semibold text-foreground">Créer une page</h1>
                        <p class="text-sm text-muted-foreground hidden sm:block">Remplissez les informations pour créer une nouvelle page</p>
                    </div>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.pages.store') }}" method="POST" x-data="pageForm()" @submit.prevent="submitForm">
            @csrf
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="space-y-2">
                            <textarea name="content"
                                      id="tinymce"
                                      class="tinymce hidden">{{ old('content') }}</textarea>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <button type="submit"
                            ...
                            <span x-text="isSubmitting ? 'Création...' : 'Créer la page'"></span>
                        </button>
                    </div>
                </div>
            ...
            return {
                ...
                init() {
                    if (this.form.title && !this.form.slug) {
                        this.generateSlug(this.form.title);
                    }
